...
```{r  eval=T, echo=F, fig.pos='H', fig.align='center', out.width=c('40%','40%'), fig.subcap=c('Accidents by Class', 'Total Number of Accidents'), fig.cap="\\label{fig:figs}'Loess-Smoothed plots of Total Accidents and Accidents by Class in the City of Toronto in the years 2007 - 2017'"}
...
```{r echo=F, fig.pos='H', fig.align='center', out.width='55%', message=F,fig.cap="\\label{fig:figs}'Pedestrian Deaths in the City of Toronto'"}
## Visualizing neighborhoods of Toronto for reference
...
knitr::include_graphics(path="pedestrians.png")
```  
...
```{r echo=F, fig.pos='H', fig.align='center', out.width='55%', message=F,fig.cap="\\label{fig:figs'}Cyclist Deaths in the City of Toronto'"}
## Visualizing neighborhoods of Toronto for reference
...
knitr::include_graphics(path="cyclists.png")
```  
...
```{r  eval=T, echo=F, fig.pos='H', fig.align='center', out.width=c('40%','40%'), fig.subcap=c('Count', 'Proportion'), fig.cap="\\label{fig:figs}Loess-Smoothed plots of Accidents by Precipitation in the City of Toronto in the years 2007 - 2017"}
p %>%
...
```{r echo = F, fig.pos='H', fig.align='center', out.width=c('50%','50%'), message=F}
plot_predict_hoodid(5)
...
```{r echo=F, fig.pos='H', fig.align='center', out.width='65%'}
## Visualizing neighborhoods of Toronto for reference
url11 <- "https://raw.githubusercontent.com/sergiosonline/data_sci_geo/master/reports/final/images/all%20years_1.png"
download.file(url = url11,
          destfile = "all-years1.png",
          mode = 'wb')

knitr::include_graphics(path="all-years1.png")
```  
```{r echo=F, fig.pos='H', fig.align='center', out.width='65%'}
## Visualizing neighborhoods of Toronto for reference
url12 <- "https://raw.githubusercontent.com/sergiosonline/data_sci_geo/master/reports/final/images/all%20years_2.png"
download.file(url = url12,
          destfile = "all-years2.png",
          mode = 'wb')

knitr::include_graphics(path="all-years2.png")
```  
